...
The **output** consists of a set of variables that describe the features of the system, collectively referred to as the state of the system. The state of a system is generally represented by <img src="https://render.githubusercontent.com/render/math?math=x"> .
